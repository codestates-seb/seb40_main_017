...
public class ApiResponse<T> {
	...
	private final static String INVALID_ACCESS_TOKEN = "유효하지 않은 엑세스 토큰";
	private final static String INVALID_REFRESH_TOKEN = "유효하지 않은 리프레시 토큰";
	private final static String NOT_EXPIRED_TOKEN_YET = "만료되지 않은 토큰";

	private final ApiResponseHeader responseHeader;
