...
// @webius - type 속성이 checkbox 또는 radio 인 경우 StyledInputCheckable 스타일 적용, 아닌 경우 일반적인 StyledInput 스타일 적용
...
// @webius - 수정 모드 ON/OFF 가능한 input. type 속성이 checkbox 또는 radio 인 경우 StyledInputCheckable 스타일 적용, 아닌 경우 일반적인 StyledInput 스타일 적용
...
// @webius - 일반 텍스트 용 Input 요소를 리턴하는 컴포넌트 작성
...
// @webius - 수정 모드 ON/OFF 가능한 input text. 일반 텍스트 용 Input 요소를 리턴하는 컴포넌트 작성
...
// @webius - 비밀번호 텍스트 용 Input 요소를 리턴하는 컴포넌트 작성
...
// @webius - 라디오 체크박스 요소를 리턴하는 컴포넌트 작성
export const InputRadio = ({ defaultValue, defaultChecked, onChange, ...props }) => {
  // @webius - 선택하는 요소마다 개별 value 가 있어야 값을 가공할 수 있기 때문에 defaultChecked 이외에도 defaultValue 를 함께 받음
...
// @webius - 수정 모드 ON/OFF 가능한 textarea
...
// @webius - Custom Hook 을 활용하여 State 값과 handle 콜백 함수를 리턴하도록 구현
